            ...
            <div class="modal-body">
              ...
              <div class="row g-2">
                <div class="col-12 mb-4">
                    <label for="select2MultipleEdit" class="form-label">Permissions</label>
                    <select id="select2MultipleEdit" class="select2 form-select" multiple>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <div class="row g-2">
                <div class="col-12 mb-4">
                    <label for="select2MultipleAdd" class="form-label">Permissions</label>
                    <select id="select2MultipleAdd" class="select2 form-select" multiple>
                      <optgroup label="Alaskan/Hawaiian Time Zone">
                        <option value="AK">Alaska</option>
                        <option value="HI">Hawaii</option>
                      </optgroup>
